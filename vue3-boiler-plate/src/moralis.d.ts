...
export namespace Moralis {
  ...
  type EthOn =
    ...
    | ((
        name: EthereumEvents.ACCOUNTS_CHANGED,
        handler: EthOnAccountsChanged
      ) => void)
  ...
  class Web3 extends NativeWeb3 {
    ...
    static setEnableWeb3: (
      enable: (options?: any) => Promise<NativeWeb3>
    ) => Promise<NativeWeb3>;
    ...
    static getWeb3Provider: (
      options: Pick<EnableOptions, "provider">
    ) => Web3Provider;
  ...
  namespace Cloud {
    ...
    type AfterDeleteRequest<T = Object> = TriggerRequest<T>; // tslint:disable-line no-empty-interface
    type BeforeDeleteRequest<T = Object> = TriggerRequest<T>; // tslint:disable-line no-empty-interface
