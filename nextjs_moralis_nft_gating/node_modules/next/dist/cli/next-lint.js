...
const nextLint = async (argv)=>{
    ...
    (0, _runLintCheck).runLintCheck(baseDir, pathsToLint, false, eslintOptions(args, defaultCacheLocation), reportErrorsOnly, maxWarnings, formatter, outputFile, strict).then(async (lintResults)=>{
