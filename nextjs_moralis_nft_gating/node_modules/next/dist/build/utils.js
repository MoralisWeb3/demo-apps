...
async function printTreeView(lists, pageInfos, serverless, { distPath , buildId , pagesDir , pageExtensions , buildManifest , appBuildManifest , middlewareManifest , useStatic404 , gzipSize =true  }) {
    ...
    const printFileTree = async ({ list , routerType  })=>{
        ...
        filterAndSortList(list).forEach((item, i, arr)=>{
            ...
            const totalDuration = ((pageInfo == null ? void 0 : pageInfo.pageDuration) || 0) + ((pageInfo == null ? void 0 : (ref6 = pageInfo.ssgPageDurations) == null ? void 0 : ref6.reduce((a, b)=>a + (b || 0), 0)) || 0);
            ...
            const uniqueCssFiles = ((ref2 = buildManifest.pages[item]) == null ? void 0 : ref2.filter((file)=>{
                var ref;
            ...
            if (pageInfo == null ? void 0 : (ref3 = pageInfo.ssgPageRoutes) == null ? void 0 : ref3.length) {
        ...
        const sharedFilesSize = (ref5 = stats.router[routerType]) == null ? void 0 : ref5.common.size.total;
        var _files;
        const sharedFiles = (_files = (ref1 = stats.router[routerType]) == null ? void 0 : ref1.common.files) != null ? _files : [];
        messages.push([
    ...
    const middlewareInfo = (ref4 = middlewareManifest.middleware) == null ? void 0 : ref4["/"];
...
async function computeFromManifest(manifests, distPath, gzipSize = true, pageInfos) {
    ...
    await Promise.all([
        ...new Set([
            ...
            ...(ref8 = (ref7 = files.app) == null ? void 0 : ref7.each.keys()) != null ? ref8 : [], 
        ]), 
    ].map(async (f)=>{
        try {
