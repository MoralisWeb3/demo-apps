...
class DevServer extends _nextServer.default {
        ...
        return new Promise(async (resolve, reject)=>{
            ...
            wp.on("aggregated", async ()=>{
                ...
                for (const [fileName, meta] of knownFiles){
                    ...
                    if (envFiles.includes(fileName)) {
                        if (envFileTimes.get(fileName) && envFileTimes.get(fileName) !== meta.timestamp) {
                            envChange = true;
                        }
           ...
           */ if (/[\\\\/]_middleware$/.test(pageName)) {
                ...
                if (envChange) {
                    ...
                    await ((ref3 = this.hotReloader) == null ? void 0 : ref3.stop());
                    await ((ref4 = this.hotReloader) == null ? void 0 : ref4.start());
                }
    ...
    setupWebSocketHandler(server, _req) {
        if (!this.addedUpgradeListener) {
            ...
            server = server || ((ref7 = _req == null ? void 0 : _req.originalRequest.socket) == null ? void 0 : ref7.server);
            if (!server) {
                ...
                server.on("upgrade", (req, socket, head)=>{
                    ...
                    if ((ref = req.url) == null ? void 0 : ref.startsWith(`${basePath || assetPrefix || ""}/_next/webpack-hmr`)) {
                        var ref6;
                        (ref6 = this.hotReloader) == null ? void 0 : ref6.onHMR(req, socket, head);
                    } else {
        ...
        if ((0, _isError).default(err) && err.stack) {
            try {
                ...
                if (frame.lineNumber && (frame == null ? void 0 : frame.file)) {
                    var ref, ref9, ref10, ref11, ref12, ref13;
                    const moduleId = frame.file.replace(/^(webpack-internal:\/\/\/|file:\/\/)/, "");
                    const src = (0, _middleware).getErrorSource(err);
                    const compilation = src === "edge-server" ? (ref = this.hotReloader) == null ? void 0 : (ref9 = ref.edgeServerStats) == null ? void 0 : ref9.compilation : (ref10 = this.hotReloader) == null ? void 0 : (ref11 = ref10.serverStats) == null ? void 0 : ref11.compilation;
                    const source = await (0, _middleware).getSourceById(!!((ref12 = frame.file) == null ? void 0 : ref12.startsWith(_path.sep)) || !!((ref13 = frame.file) == null ? void 0 : ref13.startsWith("file:")), moduleId, compilation);
