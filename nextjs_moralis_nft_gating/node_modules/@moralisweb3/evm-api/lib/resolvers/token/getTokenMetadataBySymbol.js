    ...
    return (0, api_utils_1.createEndpoint)({
        ...
        apiToResult: function (data, params) {
            return (data !== null && data !== void 0 ? data : []).map(function (token) {
                return {
                    token: evm_utils_1.Erc20Token.create(__assign(__assign({}, (0, core_1.toCamelCase)(token)), { contractAddress: token.address, chain: EvmChainResolver_1.EvmChainResolver.resolve(params.chain, core) })),
