...
exports.getTokenIdMetadata = void 0;
...
exports.getTokenIdMetadata = (0, api_utils_1.createEndpointFactory)(function (core) {
    return (0, api_utils_1.createEndpoint)({
        ...
        apiToResult: function (data, params) {
            return evm_utils_1.EvmNft.create(__assign(__assign({}, (0, core_1.toCamelCase)(data)), { chain: EvmChainResolver_1.EvmChainResolver.resolve(params.chain, core), ownerOf: data.owner_of ? evm_utils_1.EvmAddress.create(data.owner_of, core) : undefined, lastMetadataSync: data.last_metadata_sync ? new Date(data.last_metadata_sync) : undefined, lastTokenUriSync: data.last_token_uri_sync ? new Date(data.last_token_uri_sync) : undefined }));
        },
