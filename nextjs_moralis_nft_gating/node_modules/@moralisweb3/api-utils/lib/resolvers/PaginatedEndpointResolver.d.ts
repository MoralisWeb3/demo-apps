...
export declare class PaginatedEndpointResolver<ApiParams, Params extends PaginatedParams, ApiResult, AdaptedResult, JSONResult> {
    ...
    static create<ApiParams, Params extends PaginatedParams, ApiResult, AdaptedResult, JSONResult>(core: MoralisCore, endpointFactory: PaginatedEndpointFactory<ApiParams, Params, ApiResult, AdaptedResult, JSONResult>): PaginatedEndpointResolver<ApiParams, Params, ApiResult, AdaptedResult, JSONResult>;
    constructor(endpoint: PaginatedEndpoint<ApiParams, Params, ApiResult, AdaptedResult, JSONResult>, config: Config, requestController: RequestController, paramsReader: EndpointParamsReader<ApiParams, Params, PaginatedResult<ApiResult>, AdaptedResult, JSONResult>);
    private get;
    private post;
