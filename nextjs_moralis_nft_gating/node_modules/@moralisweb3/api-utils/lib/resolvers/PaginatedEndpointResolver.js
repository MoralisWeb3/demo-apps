...
var checkObjEqual_1 = require("../utils/checkObjEqual");
var getNextParams_1 = require("../utils/getNextParams");
...
var PaginatedEndpointResolver = /** @class */ (function () {
    function PaginatedEndpointResolver(endpoint, config, requestController, paramsReader) {
        var _this = this;
        ...
        this.get = function (params) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.endpoint.getUrl(params);
    ...
    PaginatedEndpointResolver.create = function (core, endpointFactory) {
